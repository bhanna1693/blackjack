...
import BlackjackPlayerHeader from '@/components/BlackjackPlayerHeader.vue'
...
<template>
  ...
  <section class="flex flex-col justify-center items-center">
    <div class="dealer">
      <PlayerHand :cards="dealer.cards">
        <template v-slot:header>
          <BlackjackPlayerHeader :player="dealer" :blackjack="blackjack" />
        </template>
    ...
    <div class="players flex justify-between">
      <PlayerHand v-for="player of blackjack.getPlayers()" :key="player.name" :cards="player.cards">
        <template v-slot:header>
          <BlackjackPlayerHeader :player="player" :blackjack="blackjack" />
        </template>
