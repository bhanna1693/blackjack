...
const { players, dealer, activePlayerIndex, isDealersTurn } = storeToRefs(blackjackStore)
</script>

<template>
  <section class="flex flex-col justify-center items-center">
    <div class="dealer" v-if="dealer.cards.length">
      ...
      <div class="mt-4 flex flex-col items-center" v-if="isDealersTurn">
        <template v-if="dealer.isPlayerBusted()">
